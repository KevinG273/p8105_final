...
top_incidents <- gun_df %>%
  ...
  slice(1:10) 
knitr::kable(
  top_incidents %>% select(date, city, state, dead, injured, total, description),
  caption = "Top 10 Incidents with the Highest Numbers of Victims"
)
...
## Interactive Map of the Incidents
