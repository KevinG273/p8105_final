...
![Number of incidents by year](EDA_code_files/figure-html/unnamed-chunk-4-1.png)
...
![Number of incidents by year](EDA_code_files/figure-html/unnamed-chunk-5-1.png)

Let's further break it down by years and quarters.

![Number of incidents by years and quarters](EDA_code_files/figure-html/unnamed-chunk-6-1.png)
...
![Number of incidents by month](EDA_code_files/figure-html/by_month.png)
...
![Dates with most incidents](EDA_code_files/figure-html/table1.png)
...
![Incidents by weekday](EDA_code_files/figure-html/unnamed-chunk-10-1.png)
...
![Incidents by state](EDA_code_files/figure-html/incidents_by_state.png)
...
![Table for Incidents Relative to State Population](EDA_code_files/figure-html/table2.png)
...
![Incidents Relative to State Population](EDA_code_files/figure-html/incidents_by_statepop.png)
...
![Interactive Map of Incidents by State](EDA_code_files/figure-html/map1.png)
...
![Table for Victims by State](EDA_code_files/figure-html/table3.png)
...
![Victims per incident by state](EDA_code_files/figure-html/unnamed-chunk-19-1.png)
...
![Victims per incident by state](EDA_code_files/figure-html/victims_statepop.png)
...
![Interactive Map of Victims by State](EDA_code_files/figure-html/map2.png)
...
![Table for incidents by city](EDA_code_files/figure-html/table4.png)

Here are the top number of incidents per city within New York State.

![Table for incidents by city within New York State ](EDA_code_files/figure-html/table5.png)


Here are the number of incidents in New York City.

![Table for incidents in New York City](EDA_code_files/figure-html/table6.png)
...
![Incidents by City](EDA_code_files/figure-html/unnamed-chunk-33-1.png)
...
![Table for Top Incidents by Victim Count](EDA_code_files/figure-html/table7.png)
...
![Interactive Map of Top Incidents by Victim Count](EDA_code_files/figure-html/map3.png)
